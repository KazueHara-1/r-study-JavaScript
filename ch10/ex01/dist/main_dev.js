...
eval("// 必要なモジュールへの参照を取得する。\r\nconst stats = __webpack_require__(/*! ./stats.cjs */ \"./stats.cjs\");\r\nconst BitSet = (__webpack_require__(/*! ./sets.cjs */ \"./sets.cjs\").BitSet);\r\n// モジュールを使ってコードを記述する。\r\nlet s = new BitSet(100);\r\ns.insert(10);\r\ns.insert(20);\r\ns.insert(30);\r\nlet average = stats.mean([...s]); // averageは20。\r\n\n\n//# sourceURL=webpack://preset-js/./index.cjs?");
